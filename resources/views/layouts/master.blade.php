 ...
 <head>
     ...
     <title>@yield('title') | Lunas Agro</title>
                 ...
                 <div class="app-brand demo">
                     <a href="/" class="app-brand-link">
                         <span class="app-brand-logo demo">
                             <img width="25" src="{{ asset('admin/assets/img/icons/brands/logo.png') }}"
                                 alt="" srcset="">
                         </span>
                         <span style="text:deco"class="app-brand-text demo menu-text fw-bolder ms-2">Lunas Agro</span>
                     </a>
                     ...
                     <footer class="content-footer footer bg-footer-theme">
                         <div
                             ...
                             <div class="mb-2 mb-md-0">
                                 ...
                                 , made with ❤️ by
                                 <a href="#" target="_blank" class="footer-link fw-bolder">J-DEV</a>
                             </div>
                         </div>
                     </footer>
                     <!-- / Footer -->
