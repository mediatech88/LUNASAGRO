<ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->is('tim-ahli') ? 'active' : '' }}">
        <a href="{{ url('/tim-ahli') }}" class="menu-link">
            ...
            <div data-i18n="Notifications">Tim Ahli</div>
        </a>
    </li>
    <li class="menu-item {{ request()->is('mitra-tani') ? 'active' : '' }}">
        <a href="{{ url('/mitra-tani') }}" class="menu-link">
            <i class="menu-icon tf-icons bx bx-user"></i>
            <div data-i18n="Connections">Mitra Tani</div>
        </a>
    </li> --}}
    <li class="menu-header small text-uppercase">
        <span class="menu-header-text">Evaluasi</span>
    </li>
    <li class="menu-item {{ request()->is('penyakit-tanaman') ? 'active' : '' }}">
        <a href="{{ url('/penyakit-tanaman') }}" class="menu-link">
            <i class="menu-icon tf-icons bx bxs-virus"></i>
            <div data-i18n="Connections">Penyakit Tanaman</div>
        </a>
    </li>
    <li class="menu-item {{ request()->is('riwayat-lahan') ? 'active' : '' }}">
        <a href="{{ url('/riwayat-lahan') }}" class="menu-link">
            <i class="menu-icon tf-icons bx bx-history"></i>
            <div data-i18n="Connections">Riwayat Lahan</div>
        </a>
    </li>
    <li class="menu-header small text-uppercase">
    ...
    <li class="menu-item {{ request()->is('tanaman') ? 'active' : '' }}">
        <a href="{{ url('/tanaman') }}" class="menu-link">
            ...
            <div data-i18n="Connections">Tanaman</div>
        </a>
    </li>
    <li class="menu-item {{ request()->is('pemupukan') ? 'active' : '' }}">
        <a href="{{ url('/pemupukan') }}" class="menu-link">
