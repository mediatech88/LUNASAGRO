...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Data User / Tim Ahli /</span> Create</h4>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="/tim-ahli">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <input name="code" id="code" type="text"
                                    ...
                                    is-invalid
                                @enderror"
                                    required id="basic-icon-default-fullname" readonly value="{{ $timahli_id }}">
                            </div>
                        </div>
