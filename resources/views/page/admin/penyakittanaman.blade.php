...
@section('title', 'Penyakit Tanaman')
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Data User /</span> Penyakit Tanaman</h4>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr>
                                    <td>1</td>
                                    <td>TP-009</td>
                                    <td>TP LUNAS KEDIRI</td>
                                    <td>Kota Kediri - Jawa Timur</td>
                                    <td>
                                        25
                                    </td>
                                    <td>
