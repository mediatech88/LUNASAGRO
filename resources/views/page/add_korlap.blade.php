...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Data User / Koordinator Lapangan /</span> Create</h4>

    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Tambah Data Korlap</h5>
                </div>
                <div class="card-body">
                    <form>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="tempelayanan" id="tempelayanan" required>
                                <option selected="">Pilih Tempat Pelayanan</option>
                            </select>
                        </div>
                        <div class="mb-3">
